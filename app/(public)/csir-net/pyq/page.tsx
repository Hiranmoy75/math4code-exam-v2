...
export const metadata = {
    title: "CSIR NET Mathematics Previous Year Question Papers (PDF)",
    description: "Download last 10 years CSIR NET Mathematical Sciences question papers with answer keys and detailed solutions.",
};

const PYQ_YEARS = [2024, 2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015];

export default function CSIRNETPYQPage() {
    return (
        <div className="min-h-screen bg-white">
            <ExamHero
                title="CSIR NET Mathematics PYQs"
                subtitle="Practice with the last 10 years' question papers to understand exam trends and improve your speed."
                        ...
                        {PYQ_YEARS.map((year) => (
                            <div key={year} className="bg-white border p-6 rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-between group">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-lg text-slate-800">CSIR NET {year}</h3>
                                        <p className="text-sm text-slate-500">Includes June & Dec Attempts</p>
                                    </div>
                                </div>
