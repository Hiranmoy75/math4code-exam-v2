                ...
                <div className="container max-w-[1200px] mx-auto px-4 md:px-6 relative z-10 text-center">
                    <div className="max-w-3xl mx-auto flex flex-col items-center">
                        <div className="inline-flex items-center gap-2 mb-5 animate-fade-in-up bg-white px-4 py-1.5 rounded-full shadow-sm border border-slate-100">
                            ...
                            <span className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Start Learning</span>
                        </div>

                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight mb-5 leading-[1.1]">
                            Explore Our Premium <br className="hidden md:block" />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Video Courses</span>
                        </h1>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="hidden lg:block w-64 shrink-0 space-y-8">
                        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm sticky top-24">
                            ...
                            <div className="space-y-1">
                                <Link href="/courses" className={`block px-3 py-2 rounded-lg text-sm font-medium transition-all ${!category ? "bg-green-50 text-green-700 border border-green-100" : "text-slate-600 hover:bg-slate-50 hover:text-slate-900"}`}>
                                    All Categories
                                </Link>
                                {categories.map((cat) => (
                                    <Link
                    ...
                    <div className="flex-1">
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            {courses?.map((course) => (
                                <Link key={course.id} href={`/courses/${course.id}`} className="group h-full block">
                                        ...
                                        <div className="p-4 flex flex-col flex-grow">
                                            ...
                                            <div className="flex items-center gap-3 text-xs text-slate-500 mb-4 pt-3 border-t border-slate-50">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <span className="truncate max-w-[100px] font-medium">{(course.profiles as any)?.full_name || "Instructor"}</span>
                                                </div>
