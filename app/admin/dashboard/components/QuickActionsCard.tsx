...
export default function QuickActionsCard() {
  return (
    <Card className="group relative overflow-hidden rounded-2xl bg-white/70 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 shadow-md backdrop-blur-md transition-all duration-500 hover:-translate-y-1 hover:shadow-xl lg:col-span-1">
      <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 via-emerald-400/5 to-teal-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      <CardHeader>
      ...
      <CardContent className="flex flex-col gap-4">
        <Link href="/admin/exams/create">
          <Button className="w-full bg-green-600 hover:bg-green-700 dark:bg-slate-800/60 dark:hover:bg-green-600 dark:text-white">
